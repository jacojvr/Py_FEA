...
filename = 'ccx_examples/steady_heat_2d_slab_unstructured'
...
#bvp.sections['eall'] = {'*type':'*solid section',
                        ...
                        #'*thickness':1.,
                        #'*velocity': [-100,0], # material velocity in the undeformed configuration
                        #}
...
for nd_Id in bvp.nd_set['000']:
    dof = t_dof(nd_Id)
    if dof in adof:
        nd_vals[nd_Id] = U[dof][0,0]

    


FE_io.write_to_vtu(bvp,'steady_res')
